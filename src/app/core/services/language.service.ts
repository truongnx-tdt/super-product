...
export class LanguageService {
    ...
    private translations: LanguageTranslation[] = [
        ...
        { id: 94, languageId: 1, key: 'dont_have_account', value: 'Don\'t have an account?', createdAt: new Date(), updatedAt: new Date() },
        { id: 95, languageId: 1, key: 'signup_title', value: 'Create Account', createdAt: new Date(), updatedAt: new Date() },
        { id: 96, languageId: 1, key: 'signup_subtitle', value: 'Join our learning community today', createdAt: new Date(), updatedAt: new Date() },
        { id: 97, languageId: 1, key: 'full_name', value: 'Full Name', createdAt: new Date(), updatedAt: new Date() },
        { id: 98, languageId: 1, key: 'confirm_password', value: 'Confirm Password', createdAt: new Date(), updatedAt: new Date() },
        { id: 99, languageId: 1, key: 'agree_terms', value: 'I agree to the Terms and Conditions', createdAt: new Date(), updatedAt: new Date() },
        { id: 100, languageId: 1, key: 'create_account', value: 'Create Account', createdAt: new Date(), updatedAt: new Date() },
        { id: 101, languageId: 1, key: 'already_have_account', value: 'Already have an account?', createdAt: new Date(), updatedAt: new Date() },
        ...
        { id: 111, languageId: 2, key: 'dont_have_account', value: 'Chưa có tài khoản?', createdAt: new Date(), updatedAt: new Date() },
        { id: 112, languageId: 2, key: 'signup_title', value: 'Tạo Tài Khoản', createdAt: new Date(), updatedAt: new Date() },
        { id: 113, languageId: 2, key: 'signup_subtitle', value: 'Tham gia cộng đồng học tập của chúng tôi ngay hôm nay', createdAt: new Date(), updatedAt: new Date() },
        { id: 114, languageId: 2, key: 'full_name', value: 'Họ và tên', createdAt: new Date(), updatedAt: new Date() },
        { id: 115, languageId: 2, key: 'confirm_password', value: 'Xác nhận mật khẩu', createdAt: new Date(), updatedAt: new Date() },
        { id: 116, languageId: 2, key: 'agree_terms', value: 'Tôi đồng ý với Điều khoản và Điều kiện', createdAt: new Date(), updatedAt: new Date() },
        { id: 117, languageId: 2, key: 'create_account', value: 'Tạo Tài Khoản', createdAt: new Date(), updatedAt: new Date() },
        { id: 118, languageId: 2, key: 'already_have_account', value: 'Đã có tài khoản?', createdAt: new Date(), updatedAt: new Date() },

        // Course Detail Page
        { id: 119, key: 'course_description', value: 'Course Description', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 120, key: 'course_modules', value: 'Course Modules', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 121, key: 'course_schedule', value: 'Course Schedule', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 122, key: 'day', value: 'Day', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 123, key: 'time', value: 'Time', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 124, key: 'topic', value: 'Topic', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 125, key: 'language', value: 'Language', languageId: 1, createdAt: new Date(), updatedAt: new Date() },
        { id: 126, key: 'enroll_now', value: 'Enroll Now', languageId: 1, createdAt: new Date(), updatedAt: new Date() },

        // Vietnamese translations
        { id: 127, key: 'course_description', value: 'Mô tả khóa học', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 128, key: 'course_modules', value: 'Các bài học', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 129, key: 'course_schedule', value: 'Lịch học', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 130, key: 'day', value: 'Ngày', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 131, key: 'time', value: 'Thời gian', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 132, key: 'topic', value: 'Chủ đề', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 133, key: 'language', value: 'Ngôn ngữ', languageId: 2, createdAt: new Date(), updatedAt: new Date() },
        { id: 134, key: 'enroll_now', value: 'Đăng ký ngay', languageId: 2, createdAt: new Date(), updatedAt: new Date() }
    ];
